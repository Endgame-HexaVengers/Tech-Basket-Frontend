  ...
  return (
    <div className="fixed bottom-5 right-5 z-[100] flex flex-col items-end gap-3 font-sans">
      ...
      <motion.button
        ...
        className="relative flex h-12 w-12 items-center justify-center rounded-full border border-white/20 bg-gradient-to-tr from-[#6B11D0] to-[#9333EA] text-white shadow-[0_10px_25px_rgba(107,17,208,0.4)]"
      ...
      >
        <AnimatePresence mode="wait">
          {isOpen ? (
            ...
            >
              {/* HEADPHONE ICON */}
              <FiHeadphones className="h-[22px] w-[22px]" />
